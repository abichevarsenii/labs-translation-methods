...
public class HTMLHighlightingLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"ELSE", "THROWS", "AT", "NEW", "ASSIGN", "PRIMITIVE_VALUE", "NULL", "INT", 
			"FLOAT", "STRING", "CHAR", "BOOLEAN", "TRUE", "FALSE", "MODIFIER", "PUBLIC", 
			"PRIVATE", "FINAL", "STATIC", "VOLATILE", "TRANSIENT", "SYNCHRONIZED", 
			"NATIVE", "ABSTRACT", "PROTECTED", "NAME", "WS"
		};
	}
