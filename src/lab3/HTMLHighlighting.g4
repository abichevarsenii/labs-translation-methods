...
value returns [String val] : PRIMITIVE_VALUE | callMethod | NEW typeVar? value | callMethod('.'value)* | nameType('.'value)* | '{' value(',' value)* '}';
declareVar returns [String val] : MODIFIER* typeVar nameType ';' | MODIFIER* typeVar (nameType ASSIGN value)(','nameType ASSIGN value)* ';';
declareField returns [String val] : annotation* declareVar;
